...
does this by repackaging the basic debian bootstrap distribution that
is available at raspbian.org. Use it in conjunction with rpi-base
which will produce a bootable image.
